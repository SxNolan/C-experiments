...
//non ho ben capito sinceramente come formare l'uovo, per cui chiedo se basti questo per la consegna, oppure se devo usare una libreria grafica esterna
#define RESET "\x1B[0m"
#define BGCOLOR(r,g,b,c) printf("\e[48;2;%d;%d;%dm" "%c" RESET, (r), (g),(b),(c))
//              "\e[48;2;RED;GREEN;BLUEm"

//DA QUEL CHE HO CAPITO LA GRANDEZZA DELL'UOVO E' FISSA (E A SCELTA)
#define ROWS    4
#define COLUMNS 4
